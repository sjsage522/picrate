...
public class RatingScoreResponse {
    ...
    @Builder
    private RatingScoreResponse(Long id, Double x, Double y, Integer rate, String label) {
        this.id = id;
        this.x = x;
        this.y = y;
        this.rate = rate;
    ...
    public RatingScoreResponse(Rating rating) {
    ...
    public RatingScoreResponse(RatingScore ratingScore) {
